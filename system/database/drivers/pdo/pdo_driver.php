...
// SQLite3 PDO driver v.0.03 by Xintrea
// Tested on CodeIgniter 1.7.1 and 1.7.2
// Based on CI_DB_pdo_driver class v.0.1
// Warning! This PDO driver work with SQLite3 only (don't SQLite2)
...
// Added by Xi
     ...
     */
    var $_count_string = 'SELECT COUNT(rowid) AS ';
