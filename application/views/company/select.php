...
<?php
	echo anchor('sites/regions_company/edit/'.$item->company_id, '<img src="/img/ico/edit.png"/>'.'E');
	echo anchor('sites/regions_company/delete/'.$item->company_id, '<img src="/img/ico/del.png"/>'.'D');
?>
		</div>
	</div>
</div>
