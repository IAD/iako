<div class="cell link">
	<div class="row">
		<div class="left_value">
			...
			if ($response->adv_id)
			{
				echo anchor('advs/codes_company/link/'.$item->code_id.'/'.$response->region_id, '<img src="/img/ico/adv.png"/>'.$item->advertise()->name); 
				echo '<br/>';
				echo anchor('advs/codes_company/link/'.$item->code_id.'/'.$response->region_id, '<img src="/img/ico/code.png"/>'.$item->comment); 
			}
			?>
		</div>
